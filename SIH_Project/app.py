...
api_key_input = st.sidebar.text_input(
    ...
    help="Paste your free key from console.groq.com/keys"
)
...
def extract_statutory_declarations_vision(pil_img, api_key):
    ...
    try:
        ...
        prompt = """
        You are an official Senior Legal Metrology Enforcement Officer inspecting a packaged commodity 
        under Rule 6 of the Legal Metrology (Packaged Commodities) Rules, 2011 (India).
        
        Analyze this packaging image thoroughly, accounting for cylindrical curvature, glare, 
        and inkjet dot-matrix printing. Extract the seven mandatory statutory declarations:

        1. "Manufacturer / Packer": The complete registered entity name and postal address of the manufacturer, packer, or marketer.
        2. "Consumer Care": The complete consumer grievance redressal mechanism (toll-free number, direct phone, or email).
        3. "Net Quantity": The declared net quantity with metric unit (e.g., '250 ml', '200 g', '100 g', '10 units').
        4. "Date": The month and year of manufacture, packing, or expiry/use-by date (e.g., 'Mfg: 05/2026', '03/2025', 'Best Before: 12 Months').
        5. "MRP": The Maximum Retail Price including currency symbol (e.g., '₹525.00', '₹285.00'). Do NOT confuse with nutrition percentages or weights.
        6. "Unit Sale Price": The unit price per g, ml, or piece (e.g., '₹2.10 / ml', '₹1.43 / g'). If not printed, calculate it mathematically from MRP and Net Quantity under Schedule II.
        7. "Country of Origin": The country of origin (e.g., 'India').
        ...
        If any declaration is genuinely missing or completely illegible on the packaging, set its value to an empty string "".
        """
...
if portal_view == "📷 Real-Time Packaging Surveillance":
    ...
    with col_upload:
        ...
        uploaded_file = st.file_uploader(
            ...
            type=["jpg", "jpeg", "png"],
            help="Supports any packaging geometry: cylindrical bottles, glass jars, cartons, and pouches."
        )
